...
|-----------|----------|---------|
| Agent | `.codex/agents/adr-setup/agent.md` | Agent instructions for ADR operations (canonical — `.codex/agents/adr-setup-agent/` was deprecated and removed 2026-03-13) |
