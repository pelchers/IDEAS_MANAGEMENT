...
- The slash command is `/log-idea`.
- The prompt-detection hook is `.claude/hooks/scripts/idea-log-detect.sh`.
- Hook registration lives in `.claude/hooks/settings.json`.
