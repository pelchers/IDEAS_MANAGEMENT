...
const NAV: Array<Omit<Command, "perform"> & { href: string }> = [
  ...
  { id: "nav.orchestrator", title: "Orchestrator", group: "Navigation", icon: "⌘", href: "/orchestrator", keywords: "terminal runner command dispatch" },
  { id: "nav.snippets", title: "Command Snippets", group: "Navigation", icon: "❯", href: "/snippets", keywords: "commands saved scripts" },
  { id: "nav.automations", title: "Automations", group: "Navigation", icon: "⚡", href: "/automations", keywords: "rules triggers" },
  { id: "nav.activity", title: "Activity", group: "Navigation", icon: "≡", href: "/activity", keywords: "timeline feed history" },
