# System Overview: Chat Reports

## What It Is

Chat Reports generates structured 8-section markdown summaries of a work session — capturing files changed, agents dispatched, key decisions, sync status, and pending items. Designed for post-session review, handoff documentation, and continuity across context resets.

## Component Map

```
.claude/
├── agents/chat-report-agent/AGENT.md          # Report generation agent
